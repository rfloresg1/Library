...
public class ListaPublicaciones<T> {
    private Node<T> head;
    private Node<T> tail;
    private int size;
...
//        }
    ...
    public boolean addAll(ListaPublicaciones<T> list){
    ...
    public boolean equals(Object obj){
        if(!(obj instanceof ListaPublicaciones))
            return false;
        ListaPublicaciones<T> list = (ListaPublicaciones) obj;
